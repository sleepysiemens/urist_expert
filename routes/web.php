...
Route::group(['namespace' => 'Admin', 'prefix' => 'admin', 'middleware' => 'admin'], function()
{
    ...
    Route::delete('/{application}', 'ApplicationController@destroy')->name('admin.application.destroy');
    ...
    Route::get('/user/{user}/add_application', 'UserController@add_application')->name('admin.user.add_app');
});
...
Route::group(['namespace' => 'Employee', 'prefix' => 'employee', 'middleware' => 'employee'], function()
{
    ...
    Route::delete('/{application}', 'ApplicationController@destroy')->name('employee.application.destroy');

    //documents
    Route::get('/documents/create/{application}', 'DocumentsController@create')->name('employee.documents.create');
    Route::get('/documents/{application}/edit', 'DocumentsController@edit')->name('employee.documents.edit');
    ...
    Route::get('/user/{user}/', 'UserController@index')->name('employee.user.index');
    Route::get('/user/{user}/add_application', 'UserController@add_application')->name('employee.user.add_app');
});
Route::group(['namespace' => 'User', 'prefix' => 'user', 'middleware' => 'user'], function()
{
    Route::get('/', 'MainController@index')->name('user.main.index');
