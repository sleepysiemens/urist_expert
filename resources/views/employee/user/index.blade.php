...
@section('content')
    <div class="glavni-sec">
        ...
        <div class="cabinitet-wrap">
            <div class="cabinitet">
                <div class="cabinitet-title">Пользователь</div>
                <div class="cabinitet-card">
                    <img src="{{asset('images/user-2.png')}}" alt="">
                    <form action="" class="cabinitet-form">
                        <fieldset class="commons-input">
                            <legend>И.Ф.О</legend>
                            <input type="text" placeholder="Мирошниченко Г.И." value="{{$user->name}}">
                        </fieldset>
                        <fieldset class="commons-input">
                            <legend>Контакты</legend>
                            <input type="number" placeholder=" 87632123456789" value="{{$user->phone}}">
                        </fieldset>
                        <fieldset class="commons-input">
                            <legend>Электронная почта</legend>
                            <input type="text" placeholder="mbg@mail.ru" value="{{$user->email}}">
                        </fieldset>
        ...
        <div class="etap-wrap">
            <div class="etap-card">
                ...
                <div>
                    1. Дата регистрации: {{$user->created_at}}
                    Номер телефона:
                    {{$user->phone}}
                </div>
            </div>
